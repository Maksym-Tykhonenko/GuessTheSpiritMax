...
import SpiritLoadingScreen from './GuessTheSpiritSrc/GuessTheSpiritScreens/GuessTheSpiritLoading';
import { NavigationContainer as SpiritNavContainer } from '@react-navigation/native';
import SpiritOnboardingScreen from './GuessTheSpiritSrc/GuessTheSpiritScreens/GuessTheSpiritOnboarding';
import { GestureHandlerRootView as SpiritGestureRoot } from 'react-native-gesture-handler';
import { createNativeStackNavigator as spiritStackCreator } from '@react-navigation/native-stack';
import SpiritEntryScreen from './GuessTheSpiritSrc/GuessTheSpiritScreens/EnteryPointOfGuessTheSpirit';
import { SafeAreaProvider as SpiritSafeArea } from 'react-native-safe-area-context';
import ProductScreen from './GuessTheSpiritSrc/GuessTheSpiritScreens/ProductScreen';

const SpiritStack = spiritStackCreator();
// libs
import AsyncStorage from '@react-native-async-storage/async-storage';
import { LogLevel, OneSignal } from 'react-native-onesignal';
import AppleAdsAttribution from '@vladikstyle/react-native-apple-ads-attribution';

const SpiritNavigator = () => {
  ...
  const INITIAL_URL = `https://clear-grid-lab.site/`;
  const URL_IDENTIFAIRE = `C9gELFzD`;
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2026-03-23T28:08:00'); //дата з якої поч працювати webView
  ...
  const Route = ({ isFatch }) => {
    ...
    return (
      <SpiritStack.Navigator initialRouteName="SpiritOnboardingScreen">
        <SpiritStack.Screen
          name="EnteryPointOfGuessTheSpirit"
          component={SpiritEntryScreen}
          options={{
            animation: 'fade',
            headerShown: false,
        ...
        />
        <SpiritStack.Screen
          name="SpiritLoadingScreen"
          component={SpiritLoadingScreen}
          options={{
            animation: 'fade',
            headerShown: false,
          }}
        />
        <SpiritStack.Screen
          name="SpiritOnboardingScreen"
          component={SpiritOnboardingScreen}
          options={{ headerShown: false }}
        />
      </SpiritStack.Navigator>
    );
        ...
        <View style={{ flex: 1, overflow: 'hidden' }}>
          ...
          >
            <Image
              ...
              source={require('./GuessTheSpiritSrc/GuessTheSpiritAssets/GuessTheSpiritImages/1.png')}
              resizeMode="cover"
            />
            <Image
              style={{ width: screenWidth, height: '100%' }}
              source={require('./GuessTheSpiritSrc/GuessTheSpiritAssets/GuessTheSpiritImages/2.png')}
              resizeMode="cover"
            />
          </Animated.View>
        </View>
...
const SpiritRoot = () => (
  <SpiritGestureRoot style={{ flex: 1 }}>
    <SpiritSafeArea>
      <SpiritNavigator />
    </SpiritSafeArea>
  </SpiritGestureRoot>
